import { AssetDocumentationDefinition, SOCIAL_KEY_DISCORD, SOCIAL_KEY_TELEGRAM, OBTAIN_KEY_MULTITOKEN_POOL, OBTAIN_KEY_ZAPPER, RISK_SMART_CONTRACT, RISK_MAINTAIN_PEG, OBTAIN_KEY_TWOTOKEN_POOL, SOCIAL_KEY_TWITTER, OBTAIN_KEY_ONETOKEN_POOL, RISK_PROTOCOL } from "./DocsInterfaces";

export const CUSTOM_JAR_DOCUMENTATION: AssetDocumentationDefinition[] = [
  {
    apiKey: "sCRV",
    social: [
      {
